...
courseModels.getAllCourse = async (searchTerm, semester) => {
    ...
    return await prisma.course.findMany({
        ...
        select: {
            ...
            examSchedule: {  // This is wrong - examSchedule shouldn't be inside classSchedules
                select: {
                    examType: true,
                    examDate: true,
                    startTime: true,
...
courseModels.createCourse = async (
    ...
    return await prisma.course.create({
        data: {
            ...
            courseSyllabusId: courseSyllabusId ? parseInt(courseSyllabusId) : undefined,
...
courseModels.editCourse = async (courseId, updateCourseInfo) => {
    ...
    const updatedCourse = await prisma.course.update({
        ...
        data: {
            ...
            credits: updateCourseInfo.credits ? parseInt(updateCourseInfo.credits) : undefined,
            seat: updateCourseInfo.seat ? parseInt(updateCourseInfo.seat) : undefined,
            section: updateCourseInfo.section ? parseInt(updateCourseInfo.section) : undefined,
            teacherId: updateCourseInfo.teacherId ? parseInt(updateCourseInfo.teacherId) : undefined,
            majorId: updateCourseInfo.majorId ? parseInt(updateCourseInfo.majorId) : undefined,
        },
        include: {
            teacher: {
                select: {
    ...
    courseModels.assignToSyllabus = async (courseId, majorId, year, recommendationType) => {
