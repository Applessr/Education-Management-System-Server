...
courseServices.studentGetEnrollCourseBySemester = async (studentId, semester) => {
    return await courseModels.studentGetEnrollCourseBySemester(studentId, semester)
};
courseServices.studentGetClassScheduleBySemester = async (studentId, semester) => {
    return await courseModels.studentGetClassScheduleBySemester(studentId, semester)
};
