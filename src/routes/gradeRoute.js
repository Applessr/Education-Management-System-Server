...
gradeRouter.get(
  ...
  gradeController.studentGetGradeBySemester
);
...
gradeRouter.get(
  "/student/GPA/semester",
  gradeController.studentGetGPABySemester
);

//teacher
gradeRouter.post("/teacher/score/:courseId", gradeController.teacherAddScore);
gradeRouter.patch(
  "/teacher/edit-score/:componentId",
  gradeController.teacherEditScore
);
